...
\definecolor{WCblue}{rgb}  {         0    0.4470    0.7410}
\definecolor{WCred}{rgb}   {    0.8500    0.3250    0.0980}
\definecolor{WCyellow}{rgb}{    0.9290    0.6940    0.1250}
...
\newcommand{\WCblueline} {\raisebox{2pt}{\tikz{\draw[-,WCblue,solid,line width = 0.9pt](0,0) -- (5mm,0);}}}
\newcommand{\WCredline} {\raisebox{2pt}{\tikz{\draw[-,WCred,solid,line width = 0.9pt](0,0) -- (5mm,0);}}}
\newcommand{\WCyellowline} {\raisebox{2pt}{\tikz{\draw[-,WCyellow,solid,line width = 0.9pt](0,0) -- (5mm,0);}}}
