...
If instead of multiplying by $u\myprime_i$ or $u\myprime_j$ the equation PERT, we multiply by the ``large'' or ``small'' component, then we are dividing the Reynolds-stress transport equation into the contribution by large and small scales.
...
\begin{flalign}
    \label{eq:intsc_3term_small}
    \left( u_i^L \pdv{u\myprime_j}{x_k} + u_j^L \pdv{u\myprime_i}{x_k} \right) u\myprime_k  = \left( u_i^L \pdv{(u_j^L + u_j^S)}{x_k} + u_j^L \pdv{(u_i^L + u_i^S)}{x_k} \right) u\myprime_k &&\\\nonumber
    \phantom{\left( u_i^L \pdv{u\myprime_j}{x_k} + u_j^L \pdv{u\myprime_i}{x_k} \right) u\myprime_k} = 
    \left( \pdv{(u_i^L u_j^L)}{x_k} + u_i^L \pdv{u_j^S}{x_k} + \pdv{u_i^S}{x_k} u_j^L  \right) u\myprime_k &&\\\nonumber
    = \left( \pdv{(u_i^L u_j^L u_k^L)}{x_k} + \pdv{(u_i^L u_j^L u_k^S)}{x_k}  \right)  + 
    \left( u_i^L \pdv{u_j^S}{x_k} + \pdv{u_i^S}{x_k} u_j^L \right)  u\myprime_k.
\end{flalign}    
 
For small scales the decomposition looks like:
\begin{flalign}
    \label{eq:intsc_3term_small}
    \left( u_i^S \pdv{u\myprime_j}{x_k} + u_j^S \pdv{u\myprime_i}{x_k} \right) u\myprime_k  = \left( u_i^S \pdv{(u_j^L + u_j^S)}{x_k} + u_j^S \pdv{(u_i^L + u_i^S)}{x_k} \right) u\myprime_k &&\\\nonumber
    \phantom{\left( u_i^L \pdv{u\myprime_j}{x_k} + u_j^L \pdv{u\myprime_i}{x_k} \right) u\myprime_k} = 
    \left( \pdv{(u_i^S u_j^S)}{x_k} + u_i^S \pdv{u_j^L}{x_k} + \pdv{u_i^L}{x_k} u_j^S  \right) u\myprime_k &&\\\nonumber
    = \left( \pdv{(u_i^S u_j^S u_k^L)}{x_k} + \pdv{(u_i^S u_j^S u_k^S)}{x_k}  \right)  + 
    \left( u_i^S \pdv{u_j^L}{x_k} + \pdv{u_i^L}{x_k} u_j^S \right)  u\myprime_k 
\end{flalign}    
